...
# Se usa dataclass con frozen=True para garantizar inmutabilidad real y
...
class Sale:
    ...
    Todos los campos son el resultado de transformar y limpiar los datos
    del CSV original.
    frozen=True garantiza inmutabilidad real: ninguna capa puede modificar
    la entidad después de su creación, previniendo corrupción de datos silenciosa.
    """
    ...
    # Región con encoding corregido (ej. 'Región 1' en lugar de 'RegiÃ³n 1')
    region: str
    ...
    # Año extraído de date para facilitar queries y particionado en BQ
    year: int
